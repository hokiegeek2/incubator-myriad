...
public class TestObjectFactory {
  ...
  public static ServiceResourceProfile getServiceResourceProfile(String profileName, Double cores, Double memory, 
    ...
    if (isExtendedResource(execCores, execMemory)) {
      ...
      return new ExtendedResourceProfile(nmProfile, cores, memory);
    }
    return new ServiceResourceProfile(profileName, cores, memory, execCores.doubleValue(), execMemory.doubleValue());
  }
